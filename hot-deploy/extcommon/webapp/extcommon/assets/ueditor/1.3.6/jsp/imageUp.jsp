    <%@ page language="java" contentType="text/html; charset=utf-8"
        ...
        <%@ page import="org.ofbiz.ext.ueditor.Uploader136" %>
...
request.setCharacterEncoding( Uploader136.ENCODEING );
response.setCharacterEncoding( Uploader136.ENCODEING );
...
Uploader136 up = new Uploader136(request);
